...
public class Phase3Template {
	public static void main(String[] args){
		...
		try{
			File infile = new File(String.format("animal.csv", tableName)); // In this project, the table names will match the input .csv files.	
			FileWriter outfile = new FileWriter(String.format("animal.sql", tableName)); // We will also name our output .sql files accordingly.
	...
	public static String getSQLInsert(String tableName, String line){
		...
		cleanValues = Arrays.asList(line.trim().split(",")); //store values and searate by commas in array and removing extra whitespaces
